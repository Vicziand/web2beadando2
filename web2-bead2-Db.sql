...
('sutieink', 'Sütijeink', '', '111', 20),
('grafikon', 'Grafikon', '', '111', 90),
('idopont_foglalas', 'Időpont foglalás', '', '111', 90),
('kilepes', 'Kilépés', '', '011', 70),
('nyitolap', 'Cukrászdánkról', '', '111', 10);
-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `sutik`
--
...
--
-- A tábla adatainak kiíratása `sutik`
--

INSERT INTO `sutik` (`id`, `nev`, `tipus`, `dijazott`) VALUES
(1, 'Süni', 'vegyes', 0),
...
--
-- Tábla szerkezet ehhez a táblához `sutiar`
--

CREATE TABLE `sutiar` (   `id` int(10) UNSIGNED NOT NULL,
...
--
-- A tábla adatainak kiíratása `sutiar`
--

INSERT INTO `sutiar` (`id`,`sutiid`, `ertek`,`egyseg`) VALUES
    (1, 32, 500, 'db'),
...
CREATE TABLE `tartalom` (   `id` int(10) UNSIGNED NOT NULL,
                          `sutiid` int(10) NOT NULL,
...
--
-- A tábla indexei `sutik`
--
ALTER TABLE `sutik`
    ADD PRIMARY KEY (`id`);

--
-- A tábla indexei `sutiar`
--
ALTER TABLE `sutiar`
    ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT a táblához `sutik`
--
ALTER TABLE `sutik`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT a táblához `sutiar`
--
ALTER TABLE `sutiar`
